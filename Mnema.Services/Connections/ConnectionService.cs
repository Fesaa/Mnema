...
) : IConnectionService
{
    ...
    public void CommunicateTooManyForAutomatedDownload(MonitoredSeries info, int amount)
    {
        DoForAll(ConnectionEvent.TooManyForAutomatedDownload, (service, connection)
